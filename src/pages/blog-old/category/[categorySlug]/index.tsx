...
//     variables: {
//       uri: `/blog/category/personal-finance`,
...
//   const { posts, name } = props?.data?.nodeByUri;
...
//         {blogtop && <div className="alignfull">{parseHtml(blogtop)}</div>}
...
//   console.log(uri)
//    return {
//      uri: "/blog/category/connexus-news",
//      headerLocation: MENUS.PRIMARY_LOCATION,
//      footerLocation: MENUS.FOOTER_LOCATION,
//    };
//  };
