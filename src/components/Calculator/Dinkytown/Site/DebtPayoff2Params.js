  ...
  KJE.parameters.set("CC_PAYMENT_MINIMUM1",2.0);
  KJE.parameters.set("CC_PAYMENT_MINIMUM2",2.0);
  KJE.parameters.set("CC_PAYMENT_MINIMUM3",3.0);
  KJE.parameters.set("CC_PAYMENT_MINIMUM4",3.0);
  KJE.parameters.set("CC_PAYMENT_MINIMUM5",4.0);
