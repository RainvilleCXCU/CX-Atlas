  ...
  KJE.parameters.set("ADJUSTABLE_MONTHS_FIXED2",60);
  KJE.parameters.set("ADJUSTABLE_MONTHS_FIXED3",12);
  KJE.parameters.set("ADJUSTABLE_RATE_CAP2",6);
  ...
  KJE.parameters.set("ARM_FIVE_YEAR_TERM",5);
  ...
  KJE.parameters.set("INTEREST_RATE3",5);
