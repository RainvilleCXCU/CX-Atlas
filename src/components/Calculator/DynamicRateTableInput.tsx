...
const DynamicRateTableInput = ({ children = <></>}: CXCalcProps): JSX.Element => {
    ...
    useEffect(() => {
    	...
    	let CXCalcFile = [{
    		...
    		onload: () => {
                ...
                window.CXCalc ? window.CXCalc?.DynamicTableInputUI?.init() : null
    		}
    	}];
...
export default DynamicRateTableInput;
