...
function DatatracValue({
    ...
    let datatracValue = state?.datatrac?.[productName]?.[value];
    const showValue = state?.datatrac?.[productName]?.ThresholdType !== 'DoesNotOutPerform' && state?.datatrac?.[productName]?.ThresholdType !== 'OutpeformsBelowThresholds';
