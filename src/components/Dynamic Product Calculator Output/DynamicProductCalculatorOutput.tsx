...
const DynamicProductCalculatorOutput = ({
  children = <></>,
  ...
  useEffect(() => {
    ...
    let CXCalcFile = [
      {
        id: "DynamicProductCalculatorOutput",
        ...
        onload: () => {
          ...
          window.CXCalc ? window.CXCalc?.DynamicProductCalculatorOutputUI?.init() : null;
        },
      },
    ];
...
export default DynamicProductCalculatorOutput;
