...
const DynamicProductCalculatorInput = ({
  children = <></>,
  ...
  useEffect(() => {
    ...
    let CXCalcFile = [
      {
        id: "DynamicProductCalculatorInput",
        ...
        onload: () => {
          ...
          window.CXCalc ? window.CXCalc?.DynamicProductCalculatorInputUI?.init() : null;
        },
      },
    ];
...
export default DynamicProductCalculatorInput;
